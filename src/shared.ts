...
<footer id="footer">
  ...
  <div class="footer-inner">
    <div class="footer-copyright">
      <span>© 2025 Rilian. All rights reserved.</span>
    </div>
    <div class="footer-row">
      <nav class="footer-nav">
        <span class="footer-nav-label">Navigation</span>
        <div class="footer-nav-links">
          <a href="/#caspian">Platform</a>
          <a href="/#dawntreader">Solutions</a>
      ...
      <div class="footer-legal">
        <div class="footer-social">
          <a href="#" aria-label="X (Twitter)">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.735-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
          </a>
